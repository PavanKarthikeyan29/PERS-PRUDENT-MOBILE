...
class SMSConfigActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_smsconfig)
    ...
    fun deleteNumber(mobile:String){
        ...
        val request = Request.Builder()
            .url(Constants.URL + "api/user/delete/sms")
            .method("POST", body)
    ...
    fun addNumber(mobile:String){
        ...
        val body = json.toString().toRequestBody(mediaType)
        val request = Request.Builder()
            .url(Constants.URL + "api/user/add/sms")
            .method("POST", body)
            .addHeader("token",token)
            .build()
    ...
    fun setAllNumbers(){
        ...
        val request = Request.Builder()
            .url(Constants.URL + "api/user/get/sms")
            .addHeader("token",token)
            .build()
    ...
    fun checkCountDisable() {
        ...
        if (layout.childCount >= 5) {
            LimitWarning.setText("Limit Reached. Mobile number can be added upto 5")
